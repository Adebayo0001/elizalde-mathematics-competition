      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="space-y-2">
          ...
          <input
            required
            type="date"
            className="w-full px-4 py-3 bg-slate-50 border border-slate-200 rounded-none focus:outline-none focus:ring-2 focus:ring-brand-blue focus:bg-white transition-all cursor-pointer"
            value={data.dob}
            ...
            max="2018-12-31"
          />
          <p className="text-xs text-slate-400">Click to open calendar and select your date of birth</p>
        </div>
        <div className="space-y-2">
