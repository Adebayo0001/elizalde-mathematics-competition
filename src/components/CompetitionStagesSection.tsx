...
export default function CompetitionStagesSection() {
  return (
    <section id="competition-stages" className="relative py-16 lg:py-28 bg-brand-green border-y border-brand-green overflow-hidden">
      ...
      <div 
        className="absolute inset-0 pointer-events-none opacity-40 mix-blend-color-burn"
        style={{ 
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-10">
        <div className="grid grid-cols-1 xl:grid-cols-12 gap-6 lg:gap-8 items-stretch">
          ...
          <div className="xl:col-span-5 flex flex-col gap-6 lg:gap-8">
            {/* Header Card */}
            <div className="bg-white/95 backdrop-blur-md rounded-[32px] p-8 lg:p-12 border border-white/20 shadow-xl flex flex-col justify-between h-auto lg:h-[420px]">
              <div>
                ...
                <h2 className="font-display font-semibold text-[36px] lg:text-[48px] text-slate-900 tracking-tight leading-[1.05] mb-10">
                  The Two Major<br className="hidden sm:block" /> Competitive Stages
                </h2>
                
                <p className="text-slate-600 font-sans text-[14px] lg:text-[15px] leading-[1.6] max-w-sm">
            ...
            {/* Accent Card */}
            <div className="bg-white/95 backdrop-blur-md rounded-[32px] p-8 lg:p-12 border border-white/20 shadow-xl flex items-center justify-center h-auto lg:h-[300px]">
              <h3 className="font-display font-bold text-[28px] lg:text-[32px] text-slate-900 text-center leading-[1.2] tracking-tight max-w-sm mx-auto">
          ...
          <div className="xl:col-span-7 flex flex-col gap-6 lg:gap-8">
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-[32px] p-8 lg:p-10 border border-white/20 shadow-lg relative overflow-hidden group hover:border-white/40 hover:shadow-xl transition-all flex-1">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div className="space-y-6">
                  <div className="flex items-center">
                    <span className="text-[10px] lg:text-[11px] font-bold font-display uppercase bg-brand-red/10 text-brand-red px-3 py-1 rounded-full border border-brand-red/20">
                      Local Level
                    </span>
                  </div>

                  <h3 className="font-display font-semibold text-[26px] lg:text-[32px] text-slate-900 tracking-tight leading-[1.2]">
                    The National Round
                  </h3>

                  <p className="text-slate-600 font-sans text-[14px] lg:text-[15px] leading-[1.6] max-w-lg">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-6 border-t border-slate-200">
                    <div className="space-y-3">
                      <div className="h-8 w-8 rounded-full bg-brand-red/10 text-brand-red flex items-center justify-center">
            ...
            <div className="bg-white/95 backdrop-blur-md rounded-[32px] p-8 lg:p-10 border border-white/20 shadow-lg relative overflow-hidden group hover:border-white/40 hover:shadow-xl transition-all flex-1">
              ...
              <div className="relative z-10 h-full flex flex-col justify-between">
                <div className="space-y-6">
                  <div className="flex items-center">
                    <span className="text-[10px] lg:text-[11px] font-bold font-display uppercase bg-brand-green/10 text-brand-green px-3 py-1 rounded-full border border-brand-green/20">
                      International
                    </span>
                  </div>
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-6 border-t border-slate-200">
                    <div className="space-y-3">
                      <div className="h-8 w-8 rounded-full bg-brand-green/10 text-brand-green flex items-center justify-center">
